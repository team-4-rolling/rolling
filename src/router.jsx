...
import Test from "./pages/RollingPage/Test";
import Test2 from "./pages/RollingPage/Test2";
    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="post/17266" element={<Test />}></Route>
          <Route path="post/17266/message" element={<Test2 />}></Route>
